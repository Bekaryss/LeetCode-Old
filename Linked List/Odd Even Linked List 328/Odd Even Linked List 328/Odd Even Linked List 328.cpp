// Odd Even Linked List 328.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	vector<int> input = { 7, 2, 4, 3 };
	ListNode* inputN = createNodes(input);
	ListNode* res = oddEvenList(inputN);
	PrintOut(res);
}
